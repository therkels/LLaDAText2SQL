...
if __name__ == "__main__":
    ...
    train_folder = "/scratch/eecs595f25_class_root/eecs595f25_class/llada_data/train_data"
    print("starting data processing")
    arrow_dataset = Dataset.from_generator(sql_instance_generator)
    arrow_dataset.save_to_disk(train_folder)
    ...
    reloaded = load_from_disk(train_folder)
    print(reloaded)
